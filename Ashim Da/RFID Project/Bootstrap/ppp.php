...
<div class="user-info-section">
		<div class="container">
			<div class="row">
				<form action="finalconf.php" method="post" enctype="multipart/form-data" >
					<div class="col-md-6">
                        ...
                        <div class="form-group">
							<input type="text" name="ExpireDate" class="form-control" id="user-ExpireDate" placeholder="ExpireDate">
                        </div>
                        <div class="form-group">
							<input type="text" name="id" class="form-control" id="user-ExpireDate" placeholder="Card No">
                        </div>
